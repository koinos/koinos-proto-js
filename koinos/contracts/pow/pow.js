...
goog.provide('proto.koinos.contracts.pow.difficulty_metadata_result');
 ...
 * @constructor
 */
proto.koinos.contracts.pow.difficulty_metadata_result = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.koinos.contracts.pow.difficulty_metadata_result, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.koinos.contracts.pow.difficulty_metadata_result.displayName = 'proto.koinos.contracts.pow.difficulty_metadata_result';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.koinos.contracts.pow.difficulty_metadata_result.prototype.toObject = function(opt_includeInstance) {
  return proto.koinos.contracts.pow.difficulty_metadata_result.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.koinos.contracts.pow.difficulty_metadata_result} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.koinos.contracts.pow.difficulty_metadata_result.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.koinos.contracts.pow.difficulty_metadata_result}
 */
proto.koinos.contracts.pow.difficulty_metadata_result.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.koinos.contracts.pow.difficulty_metadata_result;
  return proto.koinos.contracts.pow.difficulty_metadata_result.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.koinos.contracts.pow.difficulty_metadata_result} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.koinos.contracts.pow.difficulty_metadata_result}
 */
proto.koinos.contracts.pow.difficulty_metadata_result.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.koinos.contracts.pow.difficulty_metadata_result.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.koinos.contracts.pow.difficulty_metadata_result.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.koinos.contracts.pow.difficulty_metadata_result} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.koinos.contracts.pow.difficulty_metadata_result.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getValue();
  if (f != null) {
    writer.writeMessage(
 ...
 * @return {?proto.koinos.contracts.pow.difficulty_metadata}
 */
proto.koinos.contracts.pow.difficulty_metadata_result.prototype.getValue = function() {
 ...
 * @return {!proto.koinos.contracts.pow.difficulty_metadata_result} returns this
*/
proto.koinos.contracts.pow.difficulty_metadata_result.prototype.setValue = function(value) {
 ...
 * @return {!proto.koinos.contracts.pow.difficulty_metadata_result} returns this
 */
proto.koinos.contracts.pow.difficulty_metadata_result.prototype.clearValue = function() {
 ...
 * @return {boolean}
 */
proto.koinos.contracts.pow.difficulty_metadata_result.prototype.hasValue = function() {
