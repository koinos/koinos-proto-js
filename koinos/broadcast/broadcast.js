...
goog.provide('proto.koinos.broadcast.pending_transaction_failed');
 ...
 * @constructor
 */
proto.koinos.broadcast.pending_transaction_failed = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.koinos.broadcast.pending_transaction_failed, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.koinos.broadcast.pending_transaction_failed.displayName = 'proto.koinos.broadcast.pending_transaction_failed';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.koinos.broadcast.pending_transaction_failed.prototype.toObject = function(opt_includeInstance) {
  return proto.koinos.broadcast.pending_transaction_failed.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.koinos.broadcast.pending_transaction_failed} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.koinos.broadcast.pending_transaction_failed.toObject = function(includeInstance, msg) {
  var f, obj = {
    transaction: (f = msg.getTransaction()) && proto.koinos.protocol.transaction.toObject(includeInstance, f)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.koinos.broadcast.pending_transaction_failed}
 */
proto.koinos.broadcast.pending_transaction_failed.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.koinos.broadcast.pending_transaction_failed;
  return proto.koinos.broadcast.pending_transaction_failed.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.koinos.broadcast.pending_transaction_failed} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.koinos.broadcast.pending_transaction_failed}
 */
proto.koinos.broadcast.pending_transaction_failed.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.koinos.broadcast.pending_transaction_failed.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.koinos.broadcast.pending_transaction_failed.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.koinos.broadcast.pending_transaction_failed} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.koinos.broadcast.pending_transaction_failed.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getTransaction();
  if (f != null) {
    writer.writeMessage(
 ...
 * @return {?proto.koinos.protocol.transaction}
 */
proto.koinos.broadcast.pending_transaction_failed.prototype.getTransaction = function() {
  return /** @type{?proto.koinos.protocol.transaction} */ (
    jspb.Message.getWrapperField(this, proto.koinos.protocol.transaction, 1));
};
...
/**
 * @param {?proto.koinos.protocol.transaction|undefined} value
 * @return {!proto.koinos.broadcast.pending_transaction_failed} returns this
*/
proto.koinos.broadcast.pending_transaction_failed.prototype.setTransaction = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.koinos.broadcast.pending_transaction_failed} returns this
 */
proto.koinos.broadcast.pending_transaction_failed.prototype.clearTransaction = function() {
  return this.setTransaction(undefined);
};
 ...
 * @return {boolean}
 */
proto.koinos.broadcast.pending_transaction_failed.prototype.hasTransaction = function() {
  return jspb.Message.getField(this, 1) != null;
};
