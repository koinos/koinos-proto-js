...
goog.provide('proto.koinos.chain.result');
 ...
 * @constructor
 */
proto.koinos.chain.result = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.koinos.chain.result, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.koinos.chain.result.displayName = 'proto.koinos.chain.result';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.koinos.chain.result.prototype.toObject = function(opt_includeInstance) {
  return proto.koinos.chain.result.toObject(opt_includeInstance, this);
};
 ...
 *     http://goto/soy-param-migration
 * @param {!proto.koinos.chain.result} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.koinos.chain.result.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 */
proto.koinos.chain.result.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.koinos.chain.result;
  return proto.koinos.chain.result.deserializeBinaryFromReader(msg, reader);
};
 ...
 * @param {!proto.koinos.chain.result} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.koinos.chain.result}
 */
proto.koinos.chain.result.deserializeBinaryFromReader = function(msg, reader) {
 ...
 * @return {!Uint8Array}
 */
proto.koinos.chain.result.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.koinos.chain.result.serializeBinaryToWriter(this, writer);
 ...
 * @param {!proto.koinos.chain.result} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.koinos.chain.result.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getCode();
  if (f !== 0) {
    writer.writeInt32(
 ...
 * @return {number}
 */
proto.koinos.chain.result.prototype.getCode = function() {
...
/**
 * @param {number} value
 * @return {!proto.koinos.chain.result} returns this
 */
proto.koinos.chain.result.prototype.setCode = function(value) {
 ...
 */
proto.koinos.chain.result.prototype.getValue = function() {
 ...
 * @return {string}
 */
proto.koinos.chain.result.prototype.getValue_asB64 = function() {
 ...
 * @return {!Uint8Array}
 */
proto.koinos.chain.result.prototype.getValue_asU8 = function() {
 ...
 * @return {!proto.koinos.chain.result} returns this
 */
proto.koinos.chain.result.prototype.setValue = function(value) {
